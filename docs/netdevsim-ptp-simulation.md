...
flowchart TD
    ...
    detect -->|yes| hybrid["Hybrid mode:<br/>--gnss-dev /dev/gnss0<br/>--pty-links /var/run/ptp/ttyGNSS_GNSS0"]
    detect -->|no| pty_only["PTY-only mode:<br/>--pty-links /var/run/ptp/ttyGNSS_TS2PHC,/var/run/ptp/ttyGNSS_GNSS0"]
